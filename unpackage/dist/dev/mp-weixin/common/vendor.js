...
const b = true, k = "mp-weixin", T = S([]), P = k, A = S('{\n    "address": [\n        "127.0.0.1",\n        "192.168.1.106",\n        "172.31.192.1",\n        "192.168.144.1"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), E = S('[{"provider":"aliyun","spaceName":"poem","spaceId":"mp-e233ef62-9c0e-4622-a1aa-7115f4048c07","clientSecret":"BTuQBJeDn2aTX/XTVWVu5w==","endpoint":"https://api.next.bspapp.com"}]') || [];
let x = "";
try {
  x = "__UNI__D060515";
} catch (e) {
...
var se = { request: (e) => index.request(e), uploadFile: (e) => index.uploadFile(e), setStorageSync: (e, t2) => index.setStorageSync(e, t2), getStorageSync: (e) => index.getStorageSync(e), removeStorageSync: (e) => index.removeStorageSync(e), clearStorageSync: () => index.clearStorageSync() };
function re(e) {
